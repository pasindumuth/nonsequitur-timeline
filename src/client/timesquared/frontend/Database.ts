export default class Database {
    ...
    static databaseSendPost(url, params, successCallback, errCallback) {
    ...
    static rawQuery(query) {
        return new Promise (function (resolve, reject) {
            ...
            Database.databaseSendPost('/db', "query=" + encodeURIComponent(query), successCallback, errCallback);
        });
    }
        ...
        return new Promise (function (resolve, reject) {
            var timeQuery = 
                ...
                timeQueryPromise = new Promise (function (resolve, reject) {
                    ...
                    Database.databaseSendPost('/db', "query="+timeQuery, successCallback, errCallback);
                }),
                tidQuery = 
                    "SELECT COUNT(*) \
                ...
                tidQueryPromise = new Promise (function (resolve, reject) {
                    ...
                    Database.databaseSendPost('/db', "query="+tidQuery, successCallback, errCallback);
                }),
                eventsQuery = 
                    "SELECT COUNT(*) \
                    FROM trace",
                eventsQueryPromise = new Promise (function (resolve, reject) {
                    ...
                    Database.databaseSendPost('/db', "query="+eventsQuery, successCallback, errCallback);
                });
    ...
    static getEventStats(tid, func, time) {
        return new Promise (function (resolve, reject) {
            var avgStdevQuery = 
                "SELECT stdev, avg\
                FROM avg_stdev \
                ...
                avgStdevPromise = new Promise (function (resolve, reject) {
                    ...
                    Database.databaseSendPost('/db', "query="+avgStdevQuery, successCallback, errCallback);
                }),
                // TODO: Clean this up
                ...
                eventPromise = new Promise (function (resolve, reject) {
                    ...
                    Database.databaseSendPost('/db', "query="+eventQuery, successCallback, errCallback);
                });
