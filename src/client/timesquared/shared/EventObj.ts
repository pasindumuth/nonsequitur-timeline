...
export default class EventObj {
     ...
     */
    constructor(threadNumber, functionName, lockName, startTime, relativeStackDepth) {
    ...
    */
    setStackDepth(threadMinStackDepth) {
     ...
     */
    minObject(functionsReverseLookup, locknamesReverseLookup) {
        return {
