 ...
 */
 ...
 export default class TransferrableEventObj {
     ...
     * TOTAL:          = 8 Uint32
     */
    static THREADNAME_INDEX: number = 0;
    static FUNCTIONNAME_INDEX: number = 1;
    static LOCKNAME_INDEX: number = 2;
    static STARTTIME_HIGH_INDEX: number = 3;
    static STARTTIME_LOW_INDEX: number = 4;
    static ENDTIME_HIGH_INDEX: number = 5;
    static ENDTIME_LOW_INDEX: number = 6;
    static STACKDEPTH_INDEX: number = 7;
    
    static NUM_FIELDS: number = 8;
    
    // cache the value of 2^32 so we don't have to keep computing it
    static HEX_0XFFFFFFFF: number = 4294967296;

    /**
     * Converts an eventObjArray into a transferrable array
     */
    static toTransferrableArray(minEventObjArray) {
        console.log(TransferrableEventObj.LOCKNAME_INDEX);
    ...
    static fromTransferrableArray(transferrableArray) {
